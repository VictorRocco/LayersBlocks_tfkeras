...
class ResidualConv2D(tf.keras.layers.Layer):
    ...
    def __init__(self, num_out_filters,
        ...
        self.f_conv2d_1 = lbConv2D(num_out_filters=self.num_out_filters, kernel_size=self.kernel_size,
        ...
        self.f_conv2d_2 = lbConv2D(num_out_filters=self.num_out_filters, kernel_size=self.kernel_size,
                                 strides=self.strides, dilation_rate=self.dilation_rate,
                                 padding=self.padding, activation=self.activation, l2_value=self.l2_value)
